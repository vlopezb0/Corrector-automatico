...
def WellFormed(axs,debug = 0):
    '''Modelo para predecir la medida de Well_Formed
    ...
    path = current_path + "//Well_Formed//DataWellFormed.csv"
    ...
    for train,test in skf.split(X,Y):
        ...
        data.loc[test,"Predict_Well_Formed"] = pred
